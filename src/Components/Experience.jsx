...
export default function Experience() {
  return (
    <div id='experience' className='w-full justify-around flex flex-col md:flex-row bg-[#121212] gap-2 items-center mb-[-4px] justify-center text-center pt-12 pb-8 mt-[-2px] sm:space-x-[-8px]'>
